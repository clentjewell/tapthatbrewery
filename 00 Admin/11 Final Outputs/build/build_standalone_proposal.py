...
.prose h3{font-size:20px;font-weight:600;letter-spacing:-.015em;color:var(--brass);margin:52px 0 14px}
...
@media print{.top{display:none}body{background:#fff;color:#000;font-size:11pt}.wrap{padding:0;max-width:none}.tw{border-color:#ccc;break-inside:avoid}.prose h3{break-after:avoid;margin-top:26px}@page{size:A4;margin:18mm}}
</style>
</head>
<body>
