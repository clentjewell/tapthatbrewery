...
CAT = {
 ...
 35:("Brand Copy Workbook","Design","copy-deck"),
 ...
 43:("In-Market Activation Plan","Design","marketing-plan"),
...
OAP = [
    ("on-a-page-overall", "Tap That on a page", "Overall", "overall.html",
     "The whole engagement on one sheet – the read, the numbers, the CORE, the three moves, the six decisions, and what the plan cannot yet prove."),
