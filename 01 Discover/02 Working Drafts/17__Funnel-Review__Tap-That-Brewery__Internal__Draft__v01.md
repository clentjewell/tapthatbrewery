...
**The parallel funnel with no top:** ~**50% of the refill base are switchers** – owners who bought hardware elsewhere and arrived organically. This is stage 4 entry without stages 1–3's cost, and it currently has no campaign, no offer, no landing page. It is the cheapest path to 1,000 (D06 hypothesis H1).

**Wholesale as a feeder:** DMs → manager contact → (leak) → tap placement → venue refill volume. Best-responding channel; follow-up admitted loose; sports clubs gated by no cans, contracts, no taps, CUB exclusivity.
...
2. **The at-risk window (75–90 days).** Nothing touches a customer between "active" and "churned"; the first intervention is a $20 discount after the relationship has already lapsed. Churn interviews say these customers are lapsed, not lost – a pre-emptive 60/75/90-day nudge (H4) defends ~$200/month per save.
3. **Wholesale follow-up.** The only outreach channel that produced responses (DMs) leaked its leads between first reply and manager contact – pipeline discipline, not marketing, is the fix, and each converted venue compounds into standing refill volume.
...
- Membership economics used here assume the newer poster ($250/yr, $30/refill) – reconciliation pending (#15).
