...
- **Qualified by the census, not settled by it.** The discovery-session rule – cost as the customer's dirty little secret, kudos and connection doing the buying – is inverted by the client's own data. Both are true of different things: forty-nine self-selected respondents can rank what they will admit to, and status is not something anyone writes on a form. Read the ranking as the stated order, with the workshop read still live underneath it (#20B). The data: 1 Taste & Freshness **2.19**, 2 Cost **2.75**, 3 Convenience **2.81**, 4 Connection **3.61**, 5 Kudos **3.64**. Taste leads the argument; cost states itself plainly and second; connection and kudos are retention arguments, not acquisition ones.

## Two things that change this map
