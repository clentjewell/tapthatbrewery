...
| 4 | "I’ll drink too much." | Anecdotal reassurance ("put a lock on the fridge") | **Census data (n=50): 57% pour daily or most days, yet average just ~1.55 kegs a month (census)** – ownership correlates with moderation, not excess. Fold into objection-handling content; aligns with the sessionable, lower-carb range |
