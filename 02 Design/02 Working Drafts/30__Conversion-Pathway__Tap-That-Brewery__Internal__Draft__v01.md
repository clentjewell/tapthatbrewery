...
| | Accidental (today) | Designed |
|---|---|---|
| Entry | Walk-ins, 2×/yr giveaways | Five ranked entry points, always-on |
...
Instrumenting this is the highest-value measurement in the set: a counted rate changes what the taproom is worth and therefore what it is for (open item #20).

## Entry points, ranked by expected CAC

Ranking logic: how much of the funnel each entry point *skips*. The cheapest customers skip the $975 objection, the partner veto and the 3-month cycle entirely.
...
|---|---|---|---|
| Hook | Day 0–7 | Email ×2 | Welcome in voice; the "system at cost" honesty story; award proof |
...
| # | Checkpoint | Baseline (discovery) | Definition |
|---|---|---|---|
...
*Feeds into: DS03 Marketing Plan, lifecycle automation specification (GoTab/Fishbowl), campaign briefs per entry lane, DD00 Launch Playbook.*
