...
| **Refill customer records** | 206 owners / 96–113 active + at-risk + churned, with phone numbers (SMS winback proves it) | In GoTab; not yet a segmented marketing list – see #48 |
...
|---|---|---|---|---|
| 1 | **Giveaway nurture (90 days)** | Giveaway entry | Matches the #07 phasing – Spark (days 0–14): welcome, "that’s a keg system?" content, taproom invite. Negotiate (15–60): one objection per touch – Afterpay/Zip and at-cost honesty; her taps (the 1/3 non-beer wall); footprint proof + 5L mini $225; census stat (57% pour daily or most days, yet the weighted average is just **~1.55 kegs a month** – 57% of owners buy one keg or fewer (census)). Close (61–90): 50%-off close (proven 22–25 conversions), lease-to-buy once live, Keg Crew attached at purchase. Post-90: slow lane – seasonal releases, next giveaway | The proven conversion mechanic with the proven list; directly serves KR 1.2 (35+ per cycle) |
| 2 | **New-owner onboarding** | System purchase in GoTab | Day 0 setup + pour guide; day 3 "first weekend" check-in; day 7 membership pitch (the $30-off maths repays $250/yr [one of two live prices – open item #2] in ~4 months at 2 refills/month); day 21 refill reminder + Kegged & Ready board; day 30 referral ask (1,000 Tap Tokens per system referral) | Sets the refill cadence at the moment habit forms; feeds KR 1.4 (60% membership attach) |
| 3 | **Refill cadence reminder** | ~21–25 days since last fill (cadence ≈ ~1.55 kegs/month (census)) | "What’s pouring" email built off the coolroom Kegged & Ready pipeline (Tropical Hazy, Smuggler’s Haze, Espresso Martini…) – answers the range-paralysis pain ("I just get the lager because I don’t know what’s pouring") | Keeps actives active – cheaper than any save |
| 4 | **At-risk save (interval-based)** | Days since last keg, against their own median gap | At 1.15× their interval: fresh-range nudge, no discount. At 1.5× (at-risk): SMS + email, service angle ("drop the corny Tuesday, ready Friday") or delivery once live. At 2× or 90 days, whichever is later: winback offer fires (below) | Replaces the post-churn patch with a pre-churn save; serves KR 2.2 (≥40% at-risk save) |
| 4b | **The slowed-down 40%** | Interval exceeded by 1.5× and still a member | The largest and most winnable band in the base. They have cut back, not defected, and the system is still in the backyard. Lead with what is new that they would actually drink – the low-alcohol or lighter line (#14) – framed as hydration rather than beer, plus what their membership is currently paying for and not being used on. No discount: the barrier is not price, it is that beer stopped fitting |
...
- Cadence trigger (~21–25 days) is inferred from ~1.55 kegs/month (census); tune against actual GoTab inter-purchase data.
