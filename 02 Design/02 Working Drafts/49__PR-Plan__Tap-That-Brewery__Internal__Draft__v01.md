...
## Moments calendar (hooks already in the diary)

| When | Moment | Story fired |
|---|---|---|
| Early Sept 2026 | Brazilian night (booked) + music-nights momentum ("a week’s trade in 5 hours") | Lifestyle what’s-on pitches |
| Sept 2026 | Father’s Day – Smoked Barbecue Co-style bundle | GC news + lifestyle gift guides |
| October | **First/second birthday of opening** – comeback story anniversary re-hook | GC Bulletin follow-up: "a year on from the collapse story" |
| Crafted festival season **[date TBC]** | Award defence / new entries | Craft media + GC news |
| 2×/yr giveaway cycles | Winner announcement + a human-interest winner story | GC news + socials; doubles as #46 amplification content |
| Benchy launch **[TBC]** | Review units to 4WD media; launch event at the taproom | 4WD/outdoor tier |
| Club deal signings | First white-label club beer ("[Club] Lager") pour | GC news + community/sport press |
...
Measure placements, but score them the same way as everything else: taproom visits, giveaway entries and demo enquiries in the placement window (ask "how did you hear about us" at the counter – a #48 provenance field). Kill criterion: if 6 months of monthly pitching yields no placements beyond the existing Bulletin relationship, drop to moments-only pitching (giveaway winners, award season, Benchy launch) and reclaim the hours. PR never gets paid-retainer budget while the P&L is red.

## Assumptions & open items

- Franchise story requires explicit founder consent before any pitch (competitive and staff-sensitivity considerations).
- Moderation stat (70% / 1–2 kegs) must be verified from raw census data before use with media.
- Crafted festival timing, Benchy launch date, and venue anniversary (first vs second birthday in Oct 2026) all **[TBC]**.
- Burleigh Barrels collapse framing must be handled with Chris’s sign-off – it is his story to tell, and the Bulletin’s angle ("shaken but not stirred") is the safe template.
- Outlet list is a Jewell proposal; no journalist contacts verified beyond the Bulletin byline **[TBC – pull the original article byline]**.

---

*Feeds into: #51 Traditional Media Plan (advertorial option rides on PR relationships), #50 Events Plan (tasting nights as media hospitality), #46 Paid Media (social-proof creative), DS03 Marketing Plan.*
