...
| **System owned** | Owns system Y/N · bought from **Tap That / elsewhere** (the switcher flag) · type (2/3/4/6-tap, integrated, 5L mini, Benchy) · purchase date | GoTab sale record; asked at first fill for walk-in switchers | The switcher flag is the single most valuable field in the model — 50% of refill customers bought elsewhere and KR 1.1 (90 switcher acquisitions) is unmeasurable without it |
